<x-layouts.app>
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Create Kategori Program</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            <form action="{{ route('kategori-programs.store') }}" method="POST" class="max-w-2xl">
                @csrf
                @method('POST')
                ...
                <div class="mb-4">
                    <x-forms.input label="Title" name="title" type="text" value="{{ old('title') }}" required />
                </div>
                <div class="mb-4">
                    <x-forms.input label="Description" name="description" type="text" value="{{ old('description') }}" required />
                </div>
