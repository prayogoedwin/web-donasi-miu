<x-layouts.app>
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Buat Informasi</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            <form action="{{ route('informasis.store') }}" method="POST" class="max-w-2xl">
                @csrf
                @method('POST')
                ...
                <div class="mb-4">
                    <x-forms.input label="Key" name="key" type="text" value="{{ old('key') }}" required />
                </div>
                <div class="mb-4">
                    <x-forms.input label="Value" name="value" type="text" value="{{ old('value') }}" required />
                </div>
                ...
                <div class="mb-6">
                    ...
                    <select
                        ...
                        <option value="{{ $informasi['id'] }}" {{ old('parent_id') == $informasi['id'] ? 'selected' : '' }}>
                            {{ $informasi['key'] }}
                        </option>
                        @endforeach
                    </select>
